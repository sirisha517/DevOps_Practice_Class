...
NODEJS(){
  ...
  curl -L -o /tmp/${component}.service https://roboshop-artifacts.s3.amazonaws.com/${component}.service &>>${log_file}
  status_check $?
  cd /app

  print_head "extracting app content"
  unzip /tmp/${component}.service &>>${log_file}
  status_check $?
  ...
  mongo --host mongodb.devops517test.online </app/schema/${component}.service &>>${log_file}
  status_check $?
}